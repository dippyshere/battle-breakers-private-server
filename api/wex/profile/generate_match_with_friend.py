...
@wex_profile_generate_match_with_friend.route("/wex/api/game/v2/profile/<accountId>/GenerateMatchWithFriend", methods=["POST"])
async def generate_match_with_friend(request, accountId):
    """
