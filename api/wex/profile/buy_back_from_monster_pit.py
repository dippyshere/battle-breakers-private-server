...
@wex_profile_buy_back_from_monster_pit.route("/wex/api/game/v2/profile/<accountId>/BuyBackFromMonsterPit", methods=["POST"])
async def buy_back_from_monster_pit(request, accountId):
    """
