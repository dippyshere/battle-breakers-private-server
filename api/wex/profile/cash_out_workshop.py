...
async def cash_out_workshop(request: sanic.request.Request, accountId: str) -> sanic.response.JSONResponse:
    ...
    """
    # TODO: fix cooldown not applying
    ...
    exchange_rate = (await request.app.ctx.load_datatable("Content/Menus/Headquarters/HQ_AncientFactory"))[0]["Properties"]["LaborToGoldExchangeRate"][workshop_level]
