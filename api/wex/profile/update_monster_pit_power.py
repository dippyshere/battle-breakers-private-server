...
@wex_profile_update_monster_pit_power.route("/wex/api/game/v2/profile/<accountId>/UpdateMonsterPitPower", methods=["POST"])
async def update_monster_pit_power(request, accountId):
    """
